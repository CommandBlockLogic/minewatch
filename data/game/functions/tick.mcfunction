...
execute as @a[scores={join_blue=1..}] run scoreboard players reset @s join_blue
...
execute as @a[scores={join_red=1..}] run scoreboard players reset @s join_red
execute as @a[scores={begin=1..}] run function game:over
execute as @a[scores={begin=1..}] run function game:begin
execute as @a[scores={begin=1..}] run scoreboard players reset @s begin
