...
execute store result score .mw:player/get_team_tag$blue tmp run execute if entity @e[tag=blue_team]
execute store result score .mw:player/get_team_tag$red tmp run execute if entity @e[tag=red_team]
