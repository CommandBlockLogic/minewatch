...
function uid:tick
execute unless $game custom1 matches 2 if entity @s[tag=!died] run function char:player_tick
execute unless $game custom1 matches 2 run function hh:tick
execute unless $game custom1 matches 2 if entity @s[tag=!died] run function buff:tick
