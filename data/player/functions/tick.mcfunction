...
execute unless score $game custom1 matches 2 at @s if block ~ ~ ~ minecraft:lava run teleport @s[tag=!died,tag=!no_9_damage] ~ ~ ~
...
execute unless score $game custom1 matches 2 at @s if block ~ ~1 ~ minecraft:lava run teleport @s[tag=!died,tag=!no_9_damage] ~ ~ ~
