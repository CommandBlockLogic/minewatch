...
tag @s remove in_self_spawn_area
tag @s remove in_enemy_spawn_area
...
tag @s[tag=blue_team,tag=in_blue_spawn_area] add in_self_spawn_area
tag @s[tag=blue_team,tag=in_red_spawn_area] add in_enemy_spawn_area
tag @s[tag=red_team,tag=in_blue_spawn_area] add in_enemy_spawn_area
tag @s[tag=red_team,tag=in_red_spawn_area] add in_self_spawn_area
tag @s remove in_blue_spawn_area
tag @s remove in_red_spawn_area
