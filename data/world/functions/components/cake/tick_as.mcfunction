...
execute if score @s custom1 matches 481..560 run data merge entity @s {BlockState: {Name: "minecraft:air", Properties: {}}}
execute if score @s custom1 matches 401..480 run data merge entity @s {BlockState: {Name: "minecraft:cake", Properties: {bites: "6"}}}
execute if score @s custom1 matches 321..400 run data merge entity @s {BlockState: {Name: "minecraft:cake", Properties: {bites: "5"}}}
execute if score @s custom1 matches 241..320 run data merge entity @s {BlockState: {Name: "minecraft:cake", Properties: {bites: "4"}}}
execute if score @s custom1 matches 161..240 run data merge entity @s {BlockState: {Name: "minecraft:cake", Properties: {bites: "3"}}}
execute if score @s custom1 matches 81..160 run data merge entity @s {BlockState: {Name: "minecraft:cake", Properties: {bites: "2"}}}
execute if score @s custom1 matches 1..80 run data merge entity @s {BlockState: {Name: "minecraft:cake", Properties: {bites: "1"}}}
execute if score @s custom1 matches 0 run data merge entity @s {BlockState: {Name: "minecraft:cake", Properties: {bites: "0"}}}
