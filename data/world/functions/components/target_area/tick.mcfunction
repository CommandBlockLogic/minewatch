...
execute if score $targetArea custom3 matches 1.. if score $targetArea custom2 matches 0 run bossbar set .mw:process name ["", [{"color": "aqua", "score": {"objective": "tmp", "name": "blueTeamPercents"}}, "%"], {"color": "yellow", "bold": true, "text": " | "}, [{"color": "red", "score": {"objective": "tmp", "name": "redTeamPercents"}}, "%"]]
execute if score $targetArea custom3 matches 1.. if score $targetArea custom2 matches 1..10 run bossbar set .mw:process name ["", [{"color": "aqua", "score": {"objective": "tmp", "name": "blueTeamPercents"}}, "%"], {"color": "yellow", "bold": true, "text": " |加时| "}, [{"color": "red", "score": {"objective": "tmp", "name": "redTeamPercents"}}, "%"]]
execute if score $targetArea custom3 matches 1.. if score $targetArea custom2 matches 11..20 run bossbar set .mw:process name ["", [{"color": "aqua", "score": {"objective": "tmp", "name": "blueTeamPercents"}}, "%"], {"color": "yellow", "bold": true, "text": " ||加时|| "}, [{"color": "red", "score": {"objective": "tmp", "name": "redTeamPercents"}}, "%"]]
execute if score $targetArea custom3 matches 1.. if score $targetArea custom2 matches 21..30 run bossbar set .mw:process name ["", [{"color": "aqua", "score": {"objective": "tmp", "name": "blueTeamPercents"}}, "%"], {"color": "yellow", "bold": true, "text": " |||加时||| "}, [{"color": "red", "score": {"objective": "tmp", "name": "redTeamPercents"}}, "%"]]
execute if score $targetArea custom3 matches 1.. if score $targetArea custom2 matches 31..40 run bossbar set .mw:process name ["", [{"color": "aqua", "score": {"objective": "tmp", "name": "blueTeamPercents"}}, "%"], {"color": "yellow", "bold": true, "text": " ||||加时|||| "}, [{"color": "red", "score": {"objective": "tmp", "name": "redTeamPercents"}}, "%"]]
