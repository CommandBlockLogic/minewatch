...
## Switch states.
### 0 -> 1
execute if score $targetArea custom3 matches 0 if score blueCount tmp matches 1.. if score redCount tmp matches 0 run scoreboard players set $targetArea custom3 1
### 0 -> 2
execute if score $targetArea custom3 matches 0 if score blueCount tmp matches 0 if score redCount tmp matches 1.. run scoreboard players set $targetArea custom3 2
### 1 -> 0
...
execute if score $targetArea custom3 matches 6 run bossbar set .mw:process color blue
...
scoreboard players operation blueTeamPercents tmp /= 1500 const
...
scoreboard players operation redTeamPercents tmp /= 1500 const
...
## Add team process.
execute if score $targetArea custom3 matches 3..4 run scoreboard players add $blueTeam custom1 1
execute if score $targetArea custom3 matches 5..6 run scoreboard players add $redTeam custom1 1
## Add area process.
execute if score $targetArea custom3 matches 1 if score blueCount tmp matches 0 run scoreboard players remove $targetArea custom1 5
execute if score $targetArea custom3 matches 1 if score blueCount tmp matches 1 if score redCount tmp matches 0 run scoreboard players add $targetArea custom1 3
execute if score $targetArea custom3 matches 1 if score blueCount tmp matches 2 if score redCount tmp matches 0 run scoreboard players add $targetArea custom1 4
execute if score $targetArea custom3 matches 1 if score blueCount tmp matches 3.. if score redCount tmp matches 0 run scoreboard players add $targetArea custom1 5
execute if score $targetArea custom3 matches 2 if score redCount tmp matches 0 run scoreboard players remove $targetArea custom1 5
execute if score $targetArea custom3 matches 2 if score blueCount tmp matches 0 if score redCount tmp matches 1 run scoreboard players add $targetArea custom1 3
execute if score $targetArea custom3 matches 2 if score blueCount tmp matches 0 if score redCount tmp matches 2 run scoreboard players add $targetArea custom1 4
execute if score $targetArea custom3 matches 2 if score blueCount tmp matches 0 if score redCount tmp matches 3.. run scoreboard players add $targetArea custom1 5
execute if score $targetArea custom3 matches 4 if score redCount tmp matches 0 run scoreboard players remove $targetArea custom1 5
execute if score $targetArea custom3 matches 4 if score blueCount tmp matches 0 if score redCount tmp matches 1 run scoreboard players add $targetArea custom1 3
execute if score $targetArea custom3 matches 4 if score blueCount tmp matches 0 if score redCount tmp matches 2 run scoreboard players add $targetArea custom1 4
execute if score $targetArea custom3 matches 4 if score blueCount tmp matches 0 if score redCount tmp matches 3.. run scoreboard players add $targetArea custom1 5
execute if score $targetArea custom3 matches 6 if score blueCount tmp matches 0 run scoreboard players remove $targetArea custom1 5
execute if score $targetArea custom3 matches 6 if score blueCount tmp matches 1 if score redCount tmp matches 0 run scoreboard players add $targetArea custom1 3
execute if score $targetArea custom3 matches 6 if score blueCount tmp matches 2 if score redCount tmp matches 0 run scoreboard players add $targetArea custom1 4
execute if score $targetArea custom3 matches 6 if score blueCount tmp matches 3.. if score redCount tmp matches 0 run scoreboard players add $targetArea custom1 5
