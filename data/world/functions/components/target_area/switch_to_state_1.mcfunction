...
execute at @e[type=minecraft:area_effect_cloud,limit=1,tag=world_target_area_negative_point_component] run fill ~-3 ~-3 ~-3 ~16 ~16 ~16 minecraft:yellow_stained_glass replace minecraft:red_stained_glass
execute at @e[type=minecraft:area_effect_cloud,limit=1,tag=world_target_area_negative_point_component] run fill ~-3 ~-3 ~-3 ~16 ~16 ~16 minecraft:yellow_stained_glass replace minecraft:light_blue_stained_glass
