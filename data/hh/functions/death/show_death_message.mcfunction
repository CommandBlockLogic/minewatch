...
# Specific ways.
execute if score @e[tag=hh_killer,limit=1] charID matches 2 if score @s hhLastDamageWay matches 3 run data modify entity @e[type=minecraft:area_effect_cloud,tag=new_summoned,limit=1] CustomName set value '"§4\\uE003"'
