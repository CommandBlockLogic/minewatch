...
execute if score totalDamage tmp matches 1.. as @e[tag=player] if score @s uid = @e[limit=1,tag=self] hhLastDamageUid run playsound minecraft:entity.arrow.hit_player master @s
