...
execute if score unit tmp matches 6.. run scoreboard players add innateHealth tmp 1
...
scoreboard players operation unit tmp %= 10 const
execute if score unit tmp matches 6.. run scoreboard players add innateArmor tmp 1
...
scoreboard players operation unit tmp %= 10 const
execute if score unit tmp matches 6.. run scoreboard players add innateShield tmp 1
...
scoreboard players operation unit tmp %= 10 const
execute if score unit tmp matches 6.. run scoreboard players add tempArmor tmp 1
...
scoreboard players operation unit tmp %= 10 const
execute if score unit tmp matches 6.. run scoreboard players add tempShield tmp 1
...
scoreboard players operation unit tmp %= 10 const
execute if score unit tmp matches 6.. run scoreboard players add reducing tmp 1
...
scoreboard players operation unit tmp %= 10 const
execute if score unit tmp matches 6.. run scoreboard players add lost tmp 1
