...
execute if entity @s[tag=!died] if score @s pahPressShift matches 1.. if score @s charSkillACool matches 0 if score @s charSkillAChosen matches 1 run function char:scheduler/skill_active_a
execute if entity @s[tag=!died] if score @s pahPressShift matches 1.. if score @s charSkillACool matches 0 if score @s charSkillAChosen matches 2 run function char:scheduler/skill_active_b
...
execute if entity @s[tag=!died] if score @s pahPressF matches 1.. run say F
