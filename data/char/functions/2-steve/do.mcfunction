...
execute if entity @s[scores={charSkillACool=6..10}] run replaceitem entity @s hotbar.0 minecraft:water_bucket 1
execute if entity @s[scores={charSkillACool=11}] run playsound minecraft:block.lava.extinguish master @s ~ ~ ~ 1000000
execute if entity @s[scores={charSkillACool=11..19}] run replaceitem entity @s hotbar.0 minecraft:obsidian 1
execute if entity @s[scores={charSkillACool=20}] anchored eyes run function char:2-steve/private/skill_active_a_ray
execute if entity @s[scores={charSkillACool=20}] run scoreboard players set @s charSkillACool -300
