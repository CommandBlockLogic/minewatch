...
execute as @e[type=minecraft:area_effect_cloud,tag=char_2-steve_obsidian_wall,tag=my_marker,scores={custom2=100..}] at @s unless score @s custom1 matches 1 run particle minecraft:block minecraft:obsidian ~ ~ ~ 0.25 0.25 0.25 0 5 force
