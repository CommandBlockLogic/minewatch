...
# Set item.
execute if entity @s[scores={charSkillACool=..0}] if score @s hhMeleeDamage matches 1..59 run replaceitem entity @s hotbar.0 minecraft:wooden_sword{Unbreakable: 1b} 1
