...
execute if entity @s[scores={charSkillACool=5}] run playsound minecraft:block.lava.extinguish master @s ~ ~ ~ 1000000
execute if entity @s[scores={charSkillACool=5..}] run function char:2-steve/private/skill_active_a_do
