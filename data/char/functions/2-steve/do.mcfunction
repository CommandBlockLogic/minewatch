...
execute if score @s charSkillPChosen matches 2 run scoreboard operation minusOne tmp = $hhReviveTime custom1
execute if score @s charSkillPChosen matches 2 run scoreboard remove minusOne tmp 1
