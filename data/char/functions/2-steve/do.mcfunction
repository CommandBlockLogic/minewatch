...
execute if entity @s[scores={charSkillACool=1..8}] run replaceitem entity @s hotbar.0 minecraft:obsidian 1
execute if entity @s[scores={charSkillACool=9}] anchored eyes positioned ^ ^ ^ anchored feet run function char:2-steve/private/skill_active_a_ray
execute if entity @s[scores={charSkillACool=9..}] run scoreboard players set @s charSkillACool -300
