...
# Ray.
execute positioned ^ ^ ^0.1 if entity @s[ distance=..8] if block ~ ~ ~ #.mw:player_through unless entity @e[tag=player,tag=!died,tag=enemy,distance=..1.8] run function char:2-steve/private/skill_active_a_ray
