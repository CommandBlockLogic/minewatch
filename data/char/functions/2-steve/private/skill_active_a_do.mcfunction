...
# Setblock.
execute as @e[type=minecraft:area_effect_cloud,tag=new_summoned] at @s run scoreboard players set @e[type=minecraft:area_effect_cloud,tag=char_2-steve_obsidian_wall,tag=!new_summoned,distance=..1] custom1 1
