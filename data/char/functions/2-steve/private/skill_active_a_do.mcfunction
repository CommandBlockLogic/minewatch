...
execute anchored eyes positioned ^ ^ ^ anchored feet run summon minecraft:armor_stand ~ ~ ~ {Tags: ["new_summoned", "marker_with_uid", "my_marker", "fnmdp", "char_2-steve_obsidian_bullet"], ArmorItems: [{}, {}, {}, {id: "minecraft:obsidian", Count: 1b}], NoGravity: 1b, Invulnerable: 1b, Invisible: 1b, Marker: 1b}
