...
execute anchored eyes positioned ^ ^ ^1.5 anchored feet run summon minecraft:armor_stand ~ ~ ~ {Tags: ["newly_summoned", "marker_with_uid", "my_marker", "fnmdp", "fnmdp_can_hit_enemy", "fnmdp_can_damage_hitted", "char_2-steve_obsidian_bullet"], ArmorItems: [{}, {}, {}, {id: "minecraft:obsidian", Count: 1b}], NoGravity: 1b, Invulnerable: 1b, Invisible: 1b, Marker: 1b}
