...
execute at @e[type=minecraft:area_effect_cloud,tag=new_summoned] run scoreboard players operation @e[distance=..1.8,tag=player,tag=!died,tag=enemy] hhLastDamageUid = @s uid
